    ...
    html: `
      <div style="background:#0A0A0A;padding:40px;font-family:Inter,sans-serif;max-width:480px;margin:0 auto;border-radius:16px;">
        <div style="text-align:center;margin-bottom:32px;">
          <h1 style="color:#0099C4;font-size:28px;margin:0;">VITAE</h1>
        ...
        <div style="text-align:center;margin-bottom:28px;">
          <a href="${linkReset}" style="display:inline-block;background:linear-gradient(135deg,#0099C4,#0099C4);color:#0A0A0A;text-decoration:none;padding:16px 40px;border-radius:12px;font-weight:700;font-size:15px;letter-spacing:0.5px;">
...
async function enviarEmailPreConsultaRespondida(emailMedico, nomeMedico, nomePaciente, summaryIA, linkDashboard) {
  ...
  const summaryHtml = summaryIA
    ? `<div style="background:rgba(255,255,255,0.04);border:1px solid rgba(0,153,196,0.15);border-radius:12px;padding:20px;margin:20px 0;">
  ...
  await resend.emails.send({
    ...
    html: `
      <div style="background:#0A0A0A;padding:40px;font-family:Inter,sans-serif;max-width:520px;margin:0 auto;border-radius:16px;">
        <div style="text-align:center;margin-bottom:32px;">
          <h1 style="color:#0099C4;font-size:28px;margin:0;font-family:Georgia,serif;">VITAE</h1>
        ...
        <div style="text-align:center;margin:28px 0;">
          <a href="${linkDashboard}" style="display:inline-block;background:linear-gradient(135deg,#0099C4,#0099C4);color:#0A0A0A;text-decoration:none;padding:16px 40px;border-radius:12px;font-weight:700;font-size:14px;letter-spacing:0.5px;">
