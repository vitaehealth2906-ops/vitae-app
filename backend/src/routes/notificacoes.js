...
// =====================================================================
// Removido em 2026-05-10: rotas POST /lembrete-massa e GET /historico
// (Fase 10b — WhatsApp em massa via Twilio Business). O fluxo passou
// pra clique-do-médico abrindo wa.me direto pelo frontend. Sem servidor
// de envio, sem registro de disparos no banco. A tabela notificacao_disparos
// continua existindo no schema mas órfã (sem rota usando) — pode ser
// dropada em futura limpeza após 30 dias sem rollback.
// =====================================================================
